...
export function HomePage() {
  ...
  // say we export here or on a different component the props of the...
  // signup function (so we can move it forward to the backend)
  ...
  function handleChange(ev: { target: { name: string; value: string } }) {
