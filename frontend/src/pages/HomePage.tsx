            ...
            <section className="homepage-bottom">
                ...
                <section className="about-short">
                    <div className="app-purpose">
                        <p>
                            Why I created this app? Hi, my name is Oren Danon -
                            a 24 years old ex-footballer, gym enthusiast with
                            passion to Fullstack Development. I decided to
                            create this app for people like me, as the name of
                            the app might imply - gym bros (and girls).
                        </p>
                  ...
                  This app was created by me to help myself and others log their workouts comfortably.</p> */}
                    ...
                    <div className="user-benefits">
                        <p>
                            How will this app help you? As I have mentioned I
                            created this app to help myself, how? Well, to begin
                            with the issue that I had is quite a unique one,
                            logging my workouts. I could not find a proper tool
                            to log my workouts - exercises, weights, reps, did I
                            fail? Could I do more? So I decided to do just that,
                            an app that would be up to my high standards, and
                            I'm sure this app will help you one way or another.
                        </p>
                    </div>
                </section>
                ...
                <article className="feature-details">
                    ...
                    <img
                        ...
                        src={motivationalQuotesImg}
                        alt="Motivational quotes icon"
                    />

                    <img
                        className="workout-progress"
                        src={workoutProgressImg}
                        alt="Workout progress icon"
                    />

                    <img
                        className="community-socializing"
                        src={communitySocializeImg}
                        alt="Community and socializing icon"
                    />

                    <img
                        className="track-workouts"
                        src={trackWorkoutsImg}
                        alt="Track workouts icon"
                    />
                </article>
